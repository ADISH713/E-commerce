                    ...
                    <div>
                        <div className="border border-gray-200 rounded-xl p-6 lg:sticky lg:top-6">
                            ...
                            <div className="grid grid-cols-3 gap-3 mt-7 pt-6 border-t border-gray-100">
                                ...
                                <div className="text-center">
                                    <IconShieldCheck size={24} className="mx-auto text-orange-600 mb-2"/>
                                    <p className="text-xs text-gray-600">Secure</p>
                                    <p className="text-xs text-gray-600">Checkout</p>
                                </div>
                                <div className="text-center">
                                    <IconTruck size={24} className="mx-auto text-orange-600 mb-2"/>
                                    <p className="text-xs text-gray-600">Free</p>
                                    <p className="text-xs text-gray-600">Shipping</p>
                                </div>
                                <div className="text-center">
                                    <IconRefresh size={24} className="mx-auto text-orange-600 mb-2"/>
