...
function Register() {
    ...
    return (
        ...
        <div
            className="min-h-screen flex items-center justify-center md:justify-start px-4 sm:px-8 md:px-16 py-8 sm:py-10 bg-cover bg-center"
                ...
                <form onSubmit={handleSubmit} className="space-y-3.5 sm:space-y-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            required
                            className={`w-full placeholder-gray-300 bg-white/10 border rounded-md px-3 py-2.5 text-sm focus:outline-none text-white ${
                                errors.name
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                required
                                className={`w-full placeholder-gray-300 bg-white/10 border rounded-md px-3 py-2.5 pr-10 text-sm focus:outline-none text-white ${
                                    errors.password
                                        ? 'border-red-500 focus:border-red-500'
                                        : 'border-white/20 focus:border-orange-400'
                                }`}
