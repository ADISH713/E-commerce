...
function Wishlist() {
    ...
    return (
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-10">
            ...
            <h1 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-6 sm:mb-8">
                My Wishlist
            </h1>
                        ...
                        <div className="p-4">
                            ...
                            <div>
                                <div>
                                    ...
                                    <h2 className="font-medium text-gray-800 text-sm sm:text-base break-words">
                                        {item.name}
                                    </h2>
                                    ...
                                    <div className="flex items-center justify-between gap-3 mt-2">
                                        ...
                                        <button
                                            ...
                                            className="text-gray-600 hover:text-red-500 transition shrink-0"
                                        >
                                            <IconTrash size={18} />
                                        </button>
                                ...
                                <button
                                    ...
                                    className="w-full mt-4 flex items-center justify-center gap-2 bg-orange-600 text-white py-2.5 sm:py-2 rounded-md hover:bg-orange-700 transition text-sm"
                                >
